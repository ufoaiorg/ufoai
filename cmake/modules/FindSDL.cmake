...
if(SDL_LIBRARY_TEMP)
  # For SDLmain
  if(SDL_LIBRARY_MAIN AND NOT SDL_BUILDING_LIBRARY)
    list(FIND SDL_LIBRARY_TEMP "${SDL_LIBRARY_MAIN}" _SDL_MAIN_INDEX)
    if(_SDL_MAIN_INDEX EQUAL -1)
      set(SDL_LIBRARY_TEMP "${SDL_LIBRARY_MAIN}" ${SDL_LIBRARY_TEMP})
    endif()
