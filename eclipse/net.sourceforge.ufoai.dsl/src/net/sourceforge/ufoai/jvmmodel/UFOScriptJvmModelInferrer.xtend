 ...
 */
class UFOScriptJvmModelInferrer extends AbstractModelInferrer {
	 ...
	 */
	def dispatch void infer(UINodeWindow element, IAcceptor<JvmDeclaredType> acceptor, boolean isPrelinkingPhase) {
