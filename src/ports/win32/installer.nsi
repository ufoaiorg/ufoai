...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\models\aircraft\interceptor2"
  File "..\..\..\base\models\aircraft\interceptor2\*.md2"
  File "..\..\..\base\models\aircraft\interceptor2\*.jpg"
  SetOutPath "$INSTDIR\base\models\aircraft\pbw"
  File "..\..\..\base\models\aircraft\pbw\*.md2"
  File "..\..\..\base\models\aircraft\pbw\*.jpg"
  SetOutPath "$INSTDIR\base\models\aircraft\shiva"
  File "..\..\..\base\models\aircraft\shiva\*.md2"
  File "..\..\..\base\models\aircraft\shiva\*.jpg"
...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\models\aliens\shevaar"
  File "..\..\..\base\models\aliens\shevaar\*.md2"
  File "..\..\..\base\models\aliens\shevaar\*.jpg"
  File "..\..\..\base\models\aliens\shevaar\*.tag"
  File "..\..\..\base\models\aliens\shevaar\*.anm"
...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\models\animals\fish"
;  File "..\..\..\base\models\animals\fish\*.anm"
  File "..\..\..\base\models\animals\fish\*.jpg"
  File "..\..\..\base\models\animals\fish\*.md2"
...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\models\objects\vegi\palm_a"
  File "..\..\..\base\models\objects\vegi\palm_a\*.jpg"
  File "..\..\..\base\models\objects\vegi\palm_a\*.tga"
  File "..\..\..\base\models\objects\vegi\palm_a\*.anm"
  File "..\..\..\base\models\objects\vegi\palm_a\*.md2"
  ...
  SetOutPath "$INSTDIR\base\models\objects\vegi\plant_v1"
  File "..\..\..\base\models\objects\vegi\plant_v1\*.tga"
  File "..\..\..\base\models\objects\vegi\plant_v1\*.md2"
  SetOutPath "$INSTDIR\base\models\objects\vegi\palm_v1"
  File "..\..\..\base\models\objects\vegi\palm_v1\*.tga"
  File "..\..\..\base\models\objects\vegi\palm_v1\*.md2"
  SetOutPath "$INSTDIR\base\models\objects\vegi\palm_v2"
  File "..\..\..\base\models\objects\vegi\palm_v2\*.tga"
  File "..\..\..\base\models\objects\vegi\palm_v2\*.md2"
  SetOutPath "$INSTDIR\base\models\objects\vegi\palm_v3"
  File "..\..\..\base\models\objects\vegi\palm_v3\*.tga"
  File "..\..\..\base\models\objects\vegi\palm_v3\*.md2"
  SetOutPath "$INSTDIR\base\models\objects\vegi\plants"
  File "..\..\..\base\models\objects\vegi\plants\*.tga"
  File "..\..\..\base\models\objects\vegi\plants\*.md2"
...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\models\weapons\electrolaser"
  File "..\..\..\base\models\weapons\electrolaser\*.jpg"
  File "..\..\..\base\models\weapons\electrolaser\*.md2"
  ...
  SetOutPath "$INSTDIR\base\models\weapons\pbeampistol"
  File "..\..\..\base\models\weapons\pbeampistol\*.jpg"
  File "..\..\..\base\models\weapons\pbeampistol\*.md2"
  SetOutPath "$INSTDIR\base\models\weapons\pbeamcannon"
  File "..\..\..\base\models\weapons\pbeamcannon\*.jpg"
  File "..\..\..\base\models\weapons\pbeamcannon\*.md2"
  SetOutPath "$INSTDIR\base\models\weapons\pbeamrifle"
  File "..\..\..\base\models\weapons\pbeamrifle\*.jpg"
  File "..\..\..\base\models\weapons\pbeamrifle\*.md2"
...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\pics\maps\loading"
  File "..\..\..\base\pics\maps\loading\*.jpg"
  File "..\..\..\base\pics\maps\loading\*.xcf"
  File "..\..\..\base\pics\maps\loading\README"
...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\textures\tex_carpets"
  File "..\..\..\base\textures\tex_carpets\*.jpg"
  File "..\..\..\base\textures\tex_carpets\*.tga"
