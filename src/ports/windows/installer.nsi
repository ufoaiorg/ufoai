...
SectionGroup /e "Mapping" SECGROUP02
  Section "Mapping Tools" SEC02
    ...
    File "..\..\..\base\maps\spedition\*.map"
    SetOutPath "$INSTDIR\base\maps\stadium"
    File "..\..\..\base\maps\stadium\*.map"
    SetOutPath "$INSTDIR\base\maps\transport"
    File "..\..\..\base\maps\transport\*.map"
