...
#define CONTENTS_SMOKE			0x20000000
...
#define MASK_SMOKE			(CONTENTS_SOLID | CONTENTS_WATER | CONTENTS_WINDOW)
#define	MASK_VISIBILILITY	(CONTENTS_SOLID | CONTENTS_WATER | CONTENTS_SMOKE)
