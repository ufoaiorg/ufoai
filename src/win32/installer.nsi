...
; pics
  ...
  File "..\..\base\pics\*.tga"
  File "..\..\base\pics\*.pcx"
  SetOutPath "$INSTDIR\base\althud"
  File "..\..\base\pics\althud\*.tga"
  SetOutPath "$INSTDIR\base\armor"
  File "..\..\base\pics\armor\*.tga"
  SetOutPath "$INSTDIR\base\base"
  File "..\..\base\pics\base\*.tga"
  SetOutPath "$INSTDIR\base\hud"
  File "..\..\base\pics\hud\*.tga"
  SetOutPath "$INSTDIR\base\maps"
  SetOutPath "$INSTDIR\base\maps\shots"
  File "..\..\base\pics\maps\shots\*.jpg"
  SetOutPath "$INSTDIR\base\menu"
  File "..\..\base\pics\menu\*.tga"
  File "..\..\base\pics\menu\*.jpg"
  SetOutPath "$INSTDIR\base\sfx"
...
Section "SourceCode" SEC03
  ...
  File "..\game\*.c"
  File "..\game\*.h"
  SetOutPath "$INSTDIR\irix"
  File "..\irix\*.c"
  File "..\irix\Makefile.txt"
  SetOutPath "$INSTDIR\jpeg-6"
  File "..\jpeg-6\*.c"
  File "..\jpeg-6\*.h"
  File "..\jpeg-6\README"
  ...
  File "..\po\*.po"
  SetOutPath "$INSTDIR\qcommon"
  File "..\qcommon\*.c"
  File "..\qcommon\*.h"
  SetOutPath "$INSTDIR\ref_gl"
  File "..\ref_gl\*.h"
  File "..\ref_gl\*.c"
  File "..\ref_gl\*.def"
  File "..\ref_gl\*.dev"
