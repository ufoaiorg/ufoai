...
!define PRODUCT_VERSION "2.0-RC3"
...
;======================================================================
  ...
  SetOutPath "$INSTDIR\base\models\aliens\blue_light"
  File "..\..\base\models\aliens\blue_light\*.md2"
  File "..\..\base\models\aliens\blue_light\*.jpg"
  File "..\..\base\models\aliens\blue_light\*.tag"
  File "..\..\base\models\aliens\blue_light\*.anm"
  SetOutPath "$INSTDIR\base\models\aliens\blue_medium"
  File "..\..\base\models\aliens\blue_medium\*.md2"
  File "..\..\base\models\aliens\blue_medium\*.jpg"
  File "..\..\base\models\aliens\blue_medium\*.tag"
  File "..\..\base\models\aliens\blue_medium\*.anm"
