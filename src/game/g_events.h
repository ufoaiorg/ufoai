...
void G_EventShootHidden(teammask_t visMask, const fireDef_t* fd, bool firstShoot);
void G_EventShoot(const edict_t* ent, teammask_t visMask, const fireDef_t* fd, bool firstShoot, shoot_types_t shootType, int flags, const trace_t* trace, const vec3_t from, const vec3_t impact);
...
void G_EventStartShoot(const edict_t* ent, teammask_t visMask, shoot_types_t shootType, const pos3_t at);
void G_EventThrow(teammask_t visMask, const fireDef_t *fd, float dt, byte flags, const vec3_t position, const vec3_t velocity);
