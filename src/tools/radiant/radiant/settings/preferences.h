...
class PreferencesPage
{
	...
	public:
		...
		void appendSlider (const std::string& name, const std::string& registryKey, RegistryKeyObserver* keyObserver,
				gboolean draw_value, double value, double lower, double upper, double step_increment,
				double page_increment, double page_size)
		{
			m_dialog.addSlider(m_vbox, name, registryKey, keyObserver, draw_value, value, lower, upper, step_increment,
