...
// Main constructor
ModelPropertyEditor::ModelPropertyEditor (Entity* entity, const std::string& name, const std::string& options) :
...
void ModelPropertyEditor::_onBrowseButton (GtkWidget* w, ModelPropertyEditor* self)
{
