...
// Main constructor
SkinPropertyEditor::SkinPropertyEditor (Entity* entity, const std::string& name, const std::string& options) :
	_entity(entity), _key(name)
{
	...
	gtk_button_set_image(GTK_BUTTON(browseButton), gtk_image_new_from_pixbuf(
...
void SkinPropertyEditor::_onBrowseButton (GtkWidget* w, SkinPropertyEditor* self)
{
