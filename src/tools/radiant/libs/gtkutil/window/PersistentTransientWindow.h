 ...
 */
class PersistentTransientWindow: public TransientWindow {
	...
	private:
		...
		static gboolean _onParentResize(GtkWidget* w, GdkEventWindowState* e,
	...
	public:
		 ...
		 */
		PersistentTransientWindow(const std::string& title, GtkWindow* parent, bool hideOnDelete =
				false);
