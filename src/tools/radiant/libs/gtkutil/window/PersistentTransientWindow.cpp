...
PersistentTransientWindow::PersistentTransientWindow(const std::string& title, GtkWindow* parent,
		bool hideOnDelete) :
	TransientWindow(title, parent, hideOnDelete), _parent(parent) {
...
gboolean PersistentTransientWindow::_onParentResize(GtkWidget* widget, GdkEventWindowState* event,
