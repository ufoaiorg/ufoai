...
GtkWidget* create_campaign_editor (void)
{
  ...
  GTK_WIDGET_UNSET_FLAGS (geoscape_notebook, GTK_CAN_FOCUS);
  ...
  GTK_WIDGET_UNSET_FLAGS (geoscape_scrolledwindow, GTK_CAN_FOCUS);
...
GtkWidget* create_mission_dialog (void)
{
  ...
  gtk_table_attach (GTK_TABLE (mission_table), map_entry, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (map_entry, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (mission_table), music_entry, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (music_entry, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (mission_table), text_mission, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (text_mission, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (other_table), alienteam_entry, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (alienteam_entry, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (other_table), civ_team_entry, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (civ_team_entry, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (other_table), alien_equip_entry, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (alien_equip_entry, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (other_table), credits_win_entry, 1, 2, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (credits_win_entry, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (other_table), credits_civ_entry, 1, 2, 4, 5,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (credits_civ_entry, GTK_CAN_FOCUS);
  ...
  gtk_table_attach (GTK_TABLE (other_table), credits_alien_entry, 1, 2, 5, 6,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 0);
  GTK_WIDGET_UNSET_FLAGS (credits_alien_entry, GTK_CAN_FOCUS);
