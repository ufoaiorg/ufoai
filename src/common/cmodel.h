...
void Grid_MoveCalc(const routing_t *map, const actorSizeEnum_t actorSize, pathing_t *path, pos3_t from, byte crouchingSstate, int distance, byte ** fb_list, int fb_length);
