...
int UI_DrawString(const char *fontID, align_t align, int x, int y, int absX, int maxWidth, const int lineHeight, const char *c, int box_height = 0, int scroll_pos = 0, int *cur_line = NULL, qboolean increaseLine = qfalse, longlines_t method = LONGLINES_WRAP);
