...
SWIGINTERN char const *uiRadioButtonNode_t_cvar(uiRadioButtonNode_t *self){ return UI_RadioButton_GetCvar(self); }
SWIGINTERN void uiRadioButtonNode_t_set_cvar(uiRadioButtonNode_t *self,char const *name){ UI_RadioButton_SetCvar (self, name); }
...
SWIGINTERN void uiWindowNode_t_set_fill(uiWindowNode_t *self,bool value){ dynamic_cast<uiWindowNode*>(self->behaviour->manager.get())->setFill(self, value); }
...
static int _wrap_uiRadioButton_cvar(lua_State* L) {
  ...
  SWIG_check_num_args("uiRadioButtonNode_t::cvar",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("uiRadioButtonNode_t::cvar",1,"uiRadioButtonNode_t *");

  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_uiRadioButtonNode_t,0))){
    SWIG_fail_ptr("uiRadioButton_cvar",1,SWIGTYPE_p_uiRadioButtonNode_t);
  }

  result = (char *)uiRadioButtonNode_t_cvar(arg1);
  lua_pushstring(L,(const char *)result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_uiRadioButton_set_cvar(lua_State* L) {
  ...
  SWIG_check_num_args("uiRadioButtonNode_t::set_cvar",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("uiRadioButtonNode_t::set_cvar",1,"uiRadioButtonNode_t *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("uiRadioButtonNode_t::set_cvar",2,"char const *");

  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_uiRadioButtonNode_t,0))){
    SWIG_fail_ptr("uiRadioButton_set_cvar",1,SWIGTYPE_p_uiRadioButtonNode_t);
  }

  arg2 = (char *)lua_tostring(L, 2);
  uiRadioButtonNode_t_set_cvar(arg1,(char const *)arg2);
...
static swig_lua_method swig_uiRadioButton_methods[]= {
    ...
    { "cvar", _wrap_uiRadioButton_cvar},
    { "set_cvar", _wrap_uiRadioButton_set_cvar},
