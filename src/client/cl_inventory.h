...
bool INV_MoveItem(Inventory* inv, const invDef_t *toContainer, int px, int py, const invDef_t *fromContainer, invList_t *fItem, invList_t **tItem);
bool INV_LoadWeapon(const invList_t *weapon, Inventory *inv, const invDef_t *srcContainer, const invDef_t *destContainer);
