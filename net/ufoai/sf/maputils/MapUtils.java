...
public class MapUtils {
    ...
    public static void main(String[] args) {
        try {
            ...
            try{
                ...
                Matcher urlMatcher= urlLinePattern.matcher(svnInfoText); urlMatcher.find();
                out.println(urlMatcher.group());
                out.println("Subdirectory"+subDir);
                Matcher revMatcher= revisionLinePattern.matcher(svnInfoText); revMatcher.find();
    ...
    private static String load(InputStreamReader reader) throws IOException {
        String txt="";
        final int bs=131072; int numRead=0;
