...
RADIANT_PLUGIN_ARCHIVEZIP_SRCS_CPP = \
	...
	$(RADIANT_BASE)/plugins/archivezip/pkzip.cpp \
	$(RADIANT_BASE)/plugins/archivezip/zlibstream.cpp \
	\
	$(RADIANT_BASE)/libs/cmdlib/cmdlib.cpp
...
ifeq ($(BUILD_GTKRADIANT),1)
	ALL_OBJS+=$(RADIANT_OBJS) $(RADIANT_PLUGIN_MODEL_C_OBJS) $(RADIANT_PLUGIN_MODEL_CPP_OBJS) \
		...
		$(RADIANT_PLUGIN_UFOAI_CPP_OBJS)
	TARGETS+=$(RADIANT_PLUGIN_MODEL_TARGET) $(RADIANT_PLUGIN_ENTITY_TARGET) $(RADIANT_PLUGIN_IMAGE_TARGET) \
		$(RADIANT_PLUGIN_MAP_TARGET) $(RADIANT_PLUGIN_SHADERS_TARGET) $(RADIANT_PLUGIN_VFSPK3_TARGET) \
		$(RADIANT_PLUGIN_ARCHIVEZIP_TARGET) $(RADIANT_PLUGIN_UFOAI_TARGET) $(RADIANT_TARGET)
endif
