...
uforadiant: $(BUILDDIR)/.dirs $(RADIANT_PLUGIN_MODEL_TARGET) $(RADIANT_PLUGIN_ENTITY_TARGET) $(RADIANT_PLUGIN_IMAGE_TARGET) \
	$(RADIANT_PLUGIN_SOUND_TARGET) $(RADIANT_PLUGIN_MAP_TARGET) $(RADIANT_PLUGIN_SHADERS_TARGET) $(RADIANT_PLUGIN_VFSPK3_TARGET) \
...
$(RADIANT_PLUGIN_SOUND_TARGET) : $(RADIANT_PLUGIN_SOUND_CPP_OBJS)
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CPP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_SOUND_CPP_OBJS) $(RADIANT_LIBS) $(LNKFLAGS)
...
$(RADIANT_PLUGIN_UFOAI_TARGET) : $(RADIANT_PLUGIN_UFOAI_CPP_OBJS)
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
