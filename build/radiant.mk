...
ifeq ($(BUILD_GTKRADIANT),1)
	ALL_OBJS+=$(RADIANT_OBJS) $(RADIANT_PLUGIN_MODEL_C_OBJS) $(RADIANT_PLUGIN_MODEL_CPP_OBJS) \
...
$(BUILDDIR)/tools/radiant/%.o: $(SRCDIR)/%.cpp $(BUILDDIR)/.dirs
	@echo " * [RAD] $<"; \
		$(CCP) $(CPPFLAGS) $(RADIANT_CFLAGS) -o $@ -c $< $(CFLAGS_M_OPTS)
...
$(BUILDDIR)/tools/radiant/plugins_cpp/%.o: $(SRCDIR)/%.cpp $(BUILDDIR)/.dirs
	@echo " * [RAD] $<"; \
		$(CCP) $(CPPFLAGS) $(SHARED_CFLAGS) $(RADIANT_CFLAGS) -o $@ -c $< $(CFLAGS_M_OPTS)
...
$(RADIANT_PLUGIN_MODEL_TARGET) : $(RADIANT_PLUGIN_MODEL_CPP_OBJS) $(RADIANT_PLUGIN_MODEL_C_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_MODEL_C_OBJS) $(RADIANT_PLUGIN_MODEL_CPP_OBJS) $(LNKFLAGS)
$(RADIANT_PLUGIN_ENTITY_TARGET) : $(RADIANT_PLUGIN_ENTITY_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		echo "$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_ENTITY_CPP_OBJS) $(LNKFLAGS) -lglib-2.0"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_ENTITY_CPP_OBJS) $(LNKFLAGS) -lglib-2.0
$(RADIANT_PLUGIN_IMAGE_TARGET) : $(RADIANT_PLUGIN_IMAGE_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_IMAGE_CPP_OBJS) $(LNKFLAGS) -ljpeg
$(RADIANT_PLUGIN_MAP_TARGET) : $(RADIANT_PLUGIN_MAP_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_MAP_CPP_OBJS) $(LNKFLAGS)
$(RADIANT_PLUGIN_SHADERS_TARGET) : $(RADIANT_PLUGIN_SHADERS_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_SHADERS_CPP_OBJS) $(LNKFLAGS)
$(RADIANT_PLUGIN_VFSPK3_TARGET) : $(RADIANT_PLUGIN_VFSPK3_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
	echo "$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_VFSPK3_CPP_OBJS) $(LNKFLAGS) -lglib-2.0"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_VFSPK3_CPP_OBJS) $(LNKFLAGS) -lglib-2.0
$(RADIANT_PLUGIN_ARCHIVEZIP_TARGET) : $(RADIANT_PLUGIN_ARCHIVEZIP_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_PLUGIN_ARCHIVEZIP_CPP_OBJS) $(LNKFLAGS) -lglib-2.0 -lzdll

# and now link the plugins
$(RADIANT_PLUGIN_UFOAI_TARGET) : $(RADIANT_PLUGIN_UFOAI_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_LIBS) $(RADIANT_PLUGIN_UFOAI_CPP_OBJS) $(LNKFLAGS) -lglib-2.0 -lgtk-win32-2.0 -lgobject-2.0
$(RADIANT_PLUGIN_BRUSHEXPORT_TARGET) : $(RADIANT_PLUGIN_BRUSHEXPORT_CPP_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS)"; \
		$(CCP) $(LDFLAGS) $(SHARED_LDFLAGS) -o $@ $(RADIANT_LIBS) $(RADIANT_PLUGIN_BRUSHEXPORT_CPP_OBJS) $(LNKFLAGS) -lglib-2.0 -lgtk-win32-2.0 -lgobject-2.0

# Say how to link the exe
$(RADIANT_TARGET): $(RADIANT_OBJS) $(BUILDDIR)/.dirs
	@echo " * [RAD] ... linking $(LNKFLAGS) ($(RADIANT_LIBS))"; \
		$(CCP) $(LDFLAGS) -o $@ $(RADIANT_OBJS) $(RADIANT_LIBS) $(LNKFLAGS)
