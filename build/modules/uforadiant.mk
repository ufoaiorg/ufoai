...
$(TARGET)_CFLAGS   += \
	...
	-Isrc/$(RADIANT_BASE)/include \
	 ...
	 -DGSEAL_ENABLE
$(TARGET)_LDFLAGS  += -lgthread-2.0 -lvorbisfile -lvorbis -logg $(GTK_LIBS) $(GLIB_LIBS) $(GTK_SOURCEVIEW_LIBS) $(GTK_GLEXT_LIBS) $(OPENAL_LIBS) $(OPENGL_LIBS) $(XML2_LIBS) $(GDK_PIXBUF_LIBS) $(PICOMODEL_LIBS) $(SO_LIBS) -lX11 -lm -lz
