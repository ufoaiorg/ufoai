...
$(TARGET)_CFLAGS   += -DCOMPILE_UFO -DHARD_LINKED_GAME -DHARD_LINKED_CGAME -DCOMPILE_UNITTESTS $(BFD_CFLAGS) $(SDL_CFLAGS) $(CURL_CFLAGS) $(OGG_CFLAGS) $(MXML_CFLAGS) $(MUMBLE_CFLAGS) $(PNG_CFLAGS) $(JPEG_CFLAGS) $(SDL_MIXER_CFLAGS)
