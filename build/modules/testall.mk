...
$(TARGET)_LDFLAGS  += -lcunit -lpng -ljpeg $(INTL_LIBS) $(SDL_TTF_LIBS) $(SDL_IMAGE_LIBS) $(SDL_MIXER_LIBS) $(OPENGL_LIBS) $(SDL_LIBS) $(CURL_LIBS) $(THEORA_LIBS) $(XVID_LIBS) $(VORBIS_LIBS) $(SO_LIBS) -lz
$(TARGET)_SRCS      = \
	tests/test_all.c \
